...
function ht(t,e){return(e,i,n)=>((t,e,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,i),i))(e,i,{get(){return(e=>e.renderRoot?.querySelector(t)??null)(this)}})}class ct{constructor(t){(this.host=t).addController(this)}hostConnected(){}hostDisconnected(){}getItems(t){const e=Object.assign({},this.host.data).columns.find((e=>e.id==t));return e?e.items:[]}insertItem(t,e){const i=Object.assign({},this.host.data),n=i.columns.find((e=>e.id==t));if(!n)throw new Error("Column does not exist.");return n.items.push(e),this.host.textContent=JSON.stringify(i),this.host.data=i,this.host.requestUpdate("data"),e}updateItem(t,e){const i=Object.assign({},this.host.data),[n,s]=(()=>{for(const e of i.columns){const i=e.items.find((e=>e.id==t));if(i)return[i,e]}})();if(!n)throw new Error("Item not found.");if(n.content=void 0===e.content?n.content:e.content,void 0!==e.columnId&&void 0!==e.position){const t=i.columns.find((t=>t.id==e.columnId));if(!t)throw new Error("Target column not found.");s.items.splice(s.items.indexOf(n),1),t.items.splice(e.position,0,n)}this.host.textContent=JSON.stringify(i),this.host.data=i,this.host.requestUpdate("data")}deleteItem(t){const e=Object.assign({},this.host.data);for(const i of e.columns){const e=i.items.find((e=>e.id==t));e&&i.items.splice(i.items.indexOf(e),1)}this.host.textContent=JSON.stringify(e),this.host.data=e,this.host.requestUpdate("data")}}var pt=function(t,e,i,n){var s,o=arguments.length,r=o<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,n);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(r=(o<3?s(r):o>3?s(e,i,r):s(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};let ut=class extends st{constructor(){super()}update(t){super.update(t),t.has("content")&&this._input.innerText!==this.content&&(this._input.innerText=this.content)}render(){return D`<div
  ...
  `,gt([lt({reflect:!0,type:Object})],vt.prototype,"data",void 0),gt([ht("dialog")],vt.prototype,"_dialog",void 0),vt=gt([rt("kanban-board")],vt);export{vt as KanbanBoard};
