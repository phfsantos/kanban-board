...
function ht(t,e){return(e,i,n)=>((t,e,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,i),i))(e,i,{get(){return(e=>e.renderRoot?.querySelector(t)??null)(this)}})}class ct{constructor(t){(this.host=t).addController(this)}hostConnected(){}hostDisconnected(){}getItems(t){const e=Object.assign({},this.host.data).columns.find((e=>e.id==t));return e?e.items:[]}insertItem(t,e){const i=Object.assign({},this.host.data),n=i.columns.find((e=>e.id==t));if(!n)throw new Error("Column does not exist.");return n.items.push(e),this._saveData(i),e}updateColumn(t,e){const i=Object.assign({},this.host.data),[n]=i.columns.filter((e=>e.id==t));if(!n)throw new Error("Column not found.");n.title=void 0===e?n.title:e,this._saveData(i)}updateItem(t,e){const i=Object.assign({},this.host.data),[n,s]=(()=>{for(const e of i.columns){const i=e.items.find((e=>e.id==t));if(i)return[i,e]}})();if(!n)throw new Error("Item not found.");if(n.content=void 0===e.content?n.content:e.content,void 0!==e.columnId&&void 0!==e.position){const t=i.columns.find((t=>t.id==e.columnId));if(!t)throw new Error("Target column not found.");s.items.splice(s.items.indexOf(n),1),t.items.splice(e.position,0,n)}this._saveData(i)}deleteItem(t){const e=Object.assign({},this.host.data);for(const i of e.columns){const e=i.items.find((e=>e.id==t));e&&i.items.splice(i.items.indexOf(e),1)}this._saveData(e)}_saveData(t){this.host.textContent=JSON.stringify(t);const e=this.host.data;this.host.data=t,this.host.requestUpdate("data",e),this.host.dispatchEvent(new CustomEvent("kanban-save",{detail:t,bubbles:!0,composed:!0}))}}var pt=function(t,e,i,n){var s,o=arguments.length,r=o<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,n);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(r=(o<3?s(r):o>3?s(e,i,r):s(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};let ut=class extends st{constructor(){super()}update(t){super.update(t),t.has("content")&&this._input.innerText!==this.content&&(this._input.innerText=this.content)}render(){return L`<div
  ...
  `,_t([ht(".kanban__dropzone")],mt.prototype,"_dropzone",void 0),mt=_t([rt("kanban-dropzone")],mt);var ft=function(t,e,i,n){var s,o=arguments.length,r=o<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,n);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(r=(o<3?s(r):o>3?s(e,i,r):s(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};let bt=class extends st{update(t){super.update(t),t.has("title")&&this._input.innerText!==this.title&&(this._input.innerText=this.title)}render(){return L` <div
      ...
      <div class="kanban__column-items">
        ...
        ${this.items.map((t=>L`<kanban-item
                id="${t.id}"
                content="${t.content}"
              ></kanban-item>
              <kanban-dropzone></kanban-dropzone>`))}
  ...
  `,ft([lt()],bt.prototype,"id",void 0),ft([lt()],bt.prototype,"title",void 0),ft([lt({type:Array,reflect:!0})],bt.prototype,"items",void 0),ft([ht(".kanban__column-title")],bt.prototype,"_input",void 0),bt=ft([rt("kanban-column")],bt);var gt=function(t,e,i,n){var s,o=arguments.length,r=o<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,n);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(r=(o<3?s(r):o>3?s(e,i,r):s(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};let vt=class extends st{constructor(t){super(),this.kanbanAPI=new ct(this),this.data={columns:[{id:"1",title:"Todo",items:[]},{id:"2",title:"Doing",items:[]},{id:"3",title:"Done",items:[]}]},this._itemDropHandler=t=>{var e,i,n;const s=t.detail.dropzone,o=null===(n=null===(i=null===(e=s.parentElement)||void 0===e?void 0:e.parentNode)||void 0===i?void 0:i.host)||void 0===n?void 0:n.id,r=Array.from(s.parentElement.querySelectorAll("kanban-dropzone")).indexOf(s),a=t.detail.itemId;this.kanbanAPI.updateItem(a,{columnId:o,position:r})},this._itemUpdateHandler=t=>{this.kanbanAPI.updateItem(t.detail.id,{content:t.detail.content})},this._itemDeleteHandler=t=>{this._dialog.showModal(),this._dialog.addEventListener("click",(t=>{const e=this._dialog.getBoundingClientRect();(t.clientX<e.left||t.clientX>e.right||t.clientY<e.top||t.clientY>e.bottom)&&this._dialog.close("cancel")})),this._dialogConfirmButton.addEventListener("click",(t=>{t.preventDefault(),this._dialog.close(this._dialogConfirmButton.value)})),this._dialog.addEventListener("close",(e=>{"yes"===this._dialog.returnValue&&this.kanbanAPI.deleteItem(t.detail.id)}))},this._itemAddHandler=t=>{this.kanbanAPI.insertItem(t.detail.columnId,t.detail.item)},this._columnUpdateHandler=t=>{this.kanbanAPI.updateColumn(t.detail.id,t.detail.title)};const e={columns:[{id:"1",title:"Todo",items:[]},{id:"2",title:"Doing",items:[]},{id:"3",title:"Done",items:[]}]};this.data=t,t&&t.columns&&Array.isArray(t.columns)&&0!==t.columns.length||(this.data=e)}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}render(){var t,e;return L`<div
        class="kanban"
      ...
      >
        ${null===(e=null===(t=this.data)||void 0===t?void 0:t.columns)||void 0===e?void 0:e.map((t=>L`<kanban-column
            id="${t.id}"
            title="${t.title}"
  ...
  `,gt([lt({reflect:!0,type:Object,converter:{toAttribute:t=>encodeURIComponent(JSON.stringify(t)),fromAttribute:t=>JSON.parse(decodeURIComponent(String(t)))}})],vt.prototype,"data",void 0),gt([ht("dialog")],vt.prototype,"_dialog",void 0),gt([ht("dialog button[value='yes']")],vt.prototype,"_dialogConfirmButton",void 0),vt=gt([rt("kanban-board")],vt);export{vt as KanbanBoard};
