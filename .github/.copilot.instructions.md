...
- use npx for checking for eslint errors.
- do not try to run, build, compile, watch the project unless asked to do so.

6. This project:
   1. Simple kanban board to be used in a website.
   2. Refer to the README.md for information about the project.
